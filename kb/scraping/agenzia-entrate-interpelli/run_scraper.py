...
Runs the Agenzia Entrate Interpelli scraper and exits
"""
...
async def main(bucket_name: str, base_folder: str, max_concurrent: int, log_level: str):
    ...
    logger.info(f"🚀 Starting Agenzia Entrate Interpelli scraper")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run the Agenzia Entrate Interpelli scraper and upload files to GCS"
    )
    parser.add_argument(
        "--bucket-name",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="interpelli",
        help="Base folder path in GCS bucket (default: interpelli)"
    )
    parser.add_argument(
        "--max-concurrent",
        type=int,
