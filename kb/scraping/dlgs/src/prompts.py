RELEVANCE_PROMPT = """Sei un esperto commercialista italiano. Decidi se il seguente Decreto Legislativo è rilevante o meno per l'attività consulenziale, fiscale, societaria o contabile di un commercialista, leggendo esclusivamente il suo sottotitolo.
...
<Sottotitolo del Decreto Legislativo>
{dlgs_subtitle}
"""