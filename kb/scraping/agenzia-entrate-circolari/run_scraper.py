...
Runs the Agenzia Entrate Circolari scraper and exits
"""
...
async def main(bucket_name: str, base_folder: str, max_concurrent: int, log_level: str):
    ...
    logger.info(f"🚀 Starting Agenzia Entrate Circolari scraper")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run the Agenzia Entrate Circolari scraper and upload files to GCS"
    )
    parser.add_argument(
        "--bucket-name",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="circolari",
        help="Base folder path in GCS bucket (default: circolari)"
    )
    parser.add_argument(
        "--max-concurrent",
        type=int,
